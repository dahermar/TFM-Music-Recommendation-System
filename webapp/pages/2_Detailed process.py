...
if option == "Manual data":
    ...
    if st.button('Select client'):
        ...
        intensity = calculate_session_moment_intensity(st.session_state.genarated_bpms, st.session_state.minute_processed, plot_consequent=True, plot_antecedent=True)
